...
contract ZonuDexFeeSetter {
    ...
    function transferOwnership(address newOwner) external {
        require(msg.sender == owner, 'ZonuDexFeeSetter: FORBIDDEN');
        owner = newOwner;
    }
    ...
    function setSwapFee(address pair, uint32 swapFee) external {
        require((msg.sender == owner) || ((msg.sender == pairOwners[pair])), 'ZonuDexFeeSetter: FORBIDDEN');
